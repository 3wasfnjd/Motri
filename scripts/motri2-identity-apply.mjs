...
const icon='<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><rect width="512" height="512" rx="110" fill="#172832"/><path d="M90 400L200 100M422 400L312 100" stroke="#80baa1" stroke-width="22"/><text x="256" y="287" text-anchor="middle" fill="#edf3e9" font-family="Arial,sans-serif" font-weight="bold" font-size="132">M2</text></svg>';
...
const share='<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630"><rect width="1200" height="630" fill="#172832"/><path d="M100 630L420 0M1100 630L780 0" stroke="#456e60" stroke-width="28"/><text x="600" y="348" text-anchor="middle" fill="#edf3e9" font-family="Arial,sans-serif" font-weight="bold" font-size="130">MOTRI 2</text></svg>';
await sharp(Buffer.from(share)).png().toFile('static/identity/share.png');
await write('static/identity/site.webmanifest',JSON.stringify({name:'موتري 2',short_name:'موتري 2',lang:'ar',dir:'rtl',start_url:'../',scope:'../',display:'standalone',background_color:'#172832',theme_color:'#172832',icons:[192,512].map(size=>({src:`icon-${size}.png`,sizes:`${size}x${size}`,type:'image/png'}))},null,2));
