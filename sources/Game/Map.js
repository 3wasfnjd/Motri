...
export class Map
{
    ...
    setLocations()
    {
        ...
        this.locations.items = [
            ...
            { name: 'حوش الغنم', respawnName: 'sheepPen', offset: { x: -.02, y: -.01 } },
            { name: 'مراح الإبل', respawnName: 'camelCamp', offset: { x: .02, y: -.035 } },
    ...
    setTexture()
    {
        ...
        this.texture.update = () =>
        {
            ...
            if(url !== this.texture.previousUrl)
            {
                ...
                this.game.world.camelCamp?.drawMap(this.element, url.includes('night'))
            }
        }
    }
